...
export const _fullName = (index: number) =>
  ...
  export const _profil = (index: number) =>
    [
...
export const _boolean = (index: number) =>
  ...
  export const _cb= (index: number) =>
    [
      
    ][index];

export const _libelle = (index: number) =>
  [

  ][index];

export const _pa = (index: number) =>
    [
      
    ][index];


export const _pv= (index: number) =>
      [
       
      ][index];

 export const _tva= (index: number) =>
        [
